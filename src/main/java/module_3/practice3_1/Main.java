/**
 ...
 Задание 4.
 a)	Разработать класс для хранения данных Music, объект которого будет хранить название (тип String), исполнителя (типа String), рейтинг (тип int),
 длительность трека (int), жанр (String)
